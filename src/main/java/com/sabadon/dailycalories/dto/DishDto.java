...
public record DishDto(
        ...
        @Positive(message = "Количество белков должно быть положительным")
        BigDecimal proteins,
        @NotNull(groups = OnCreate.class, message = "Количество жиров за порцию не может быть пустым")
        @Positive(message = "Количество жиров должно быть положительным")
        BigDecimal fats,
        @NotNull(groups = OnCreate.class, message = "Количество углеводов за порцию не может быть пустым")
        @Positive(message = "Количество углеводов должно быть положительным")
        BigDecimal carbs
) {
}
